...
#+begin_comment
Part of first unit in AU-2017. Extended with more SQL features to impart more SQL - data manipulation 
knowledge.
#+end_comment
...
#+begin_comment
Second unit in AU-2017. Added database triggers,views and SQL/PSM to provide better
 knowledge towards database programming. DB design is treated with maximum level of BCNF and the 
 higher NFs (4NF and 5NF) are ignored.
#+end_comment
...
#+begin_comment
Added as new unit to meet recent trends in database and the need of alternative data model to resolve the issue in data storage in distributed environment.
#+end_comment
